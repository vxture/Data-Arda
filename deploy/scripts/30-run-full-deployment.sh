...
# nginx-config step; TLS lives on the shared public edge.
#
# Options:
...
log_info "Domain:  $APEX_DOMAIN (fronted by the public edge)"
...
echo ""
echo "  Next steps:"
echo "  1. Confirm the edge vhost is installed (configs/edge/)."
